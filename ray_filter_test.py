'''
This script loads a robot urdf, adds a collision filter, and 
then measures the height of points on the ground exluding the robot.
...
robotID = p.loadURDF(
             'urdf/llllll.urdf', # 'crab_urdf/crab_model.urdf', #
...
for i in range(300):
    ...
    p.setJointMotorControlArray(
            ...
            targetVelocities = -5*np.ones(num_joints)*np.sin(i/15))
