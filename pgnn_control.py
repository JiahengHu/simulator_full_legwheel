'''
This version uses LSTM implementation LSTMCell
in place of torch one, because I want double differentiability.

TODO: 
- in compute_messages_out_function, remove loop over ports, and instead,
  have one head for each port and do them all at once.

'''
import torch
from LSTMCell import LSTMCell

# initialize layer weights to small values
