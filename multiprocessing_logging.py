...
# https://raw.githubusercontent.com/jruere/multiprocessing-logging/master/multiprocessing_logging.py
# to reduce number of pip installs needed to run on a new machine.
